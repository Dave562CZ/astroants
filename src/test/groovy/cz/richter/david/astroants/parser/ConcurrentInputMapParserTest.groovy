...
class ConcurrentInputMapParserTest extends Specification {
    ...
    def "test correct parsing of map strings"() {
        ...
        def mapStringsParserImpl = new ConcurrentInputMapParser(mapSettingsParser)
    ...
    def "test correct sorting of resulting list"() {
        given:
        def mapStringsParserImpl = new ConcurrentInputMapParser(new MapLocationParserImpl())
